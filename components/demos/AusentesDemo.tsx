...
const mensajeWP = `👋 Hola Luna IMPORTANTE⚠️ si no asistis al control de Brackets, el tratamiento no solo NO avanza, sino que tus dientes pueden volver a donde estaban antes?

Te recomiendo agendar un turno a la brevedad.
    ...
    <div className="w-full h-full flex flex-col overflow-hidden rounded-xl select-none"
      ...
      <div className="flex items-center justify-between px-3 py-1.5 shrink-0 border-b"
        ...
        <div className="flex items-center gap-1.5 font-bold" style={{ fontSize:10 }}>
          ...
          <span className="text-white/70 font-normal" style={{ fontSize:8 }}>Mensajes a pacientes ausentes</span>
        </div>
          ...
          <div className="flex-1 overflow-y-auto px-3 py-3 flex flex-col gap-2"
            ...
            <div className="flex justify-end">
              <div className="max-w-[80%] rounded-lg px-2.5 py-2 relative" style={{ background:"#005c4b" }}>
                ...
                <div className="flex items-center justify-end gap-1 mt-1">
                  <span className="text-white/50" style={{ fontSize:6 }}>2:33</span>
            ...
            <div className="flex justify-start">
              <div className="max-w-[60%] rounded-lg px-2.5 py-2 relative" style={{ background:"#1f2c34" }}>
                <div className="text-white" style={{ fontSize:7.5 }}>Hola! El martes puedo a las 10</div>
                <div className="text-white/40 text-right mt-0.5" style={{ fontSize:6 }}>2:47</div>
