...
const mensajeWP = `Hola, Rosalia.

Ponete brackets en toda la boca. Ultimo dia! 😱

3 CUOTAS SIN INTERES (con tarjeta de credito)
Metálicos $51.333 cada cuota
    ...
    <div className="w-full h-full flex flex-col overflow-hidden rounded-xl select-none"
      ...
      <div className="flex items-center justify-between px-3 py-1.5 shrink-0 border-b"
        ...
        <div className="flex items-center gap-1.5 font-bold" style={{ fontSize:10 }}>
          ...
          <span className="text-white/70 font-normal" style={{ fontSize:8 }}>Campaña de promociones</span>
        </div>
      ...
      {screen === "Flujo n8n" && (
        <div className="flex-1 overflow-auto relative" style={{ background:"#111118" }}>
          ...
          <div className="absolute bottom-2 right-2 px-2 py-1 rounded flex items-center gap-1"
            ...
            <span className="w-1.5 h-1.5 rounded-full bg-green-400 inline-block" />
            Ejecuta automáticamente al mediodía
          </div>
        </div>
      )}
        ...
        <div className="flex-1 overflow-hidden flex flex-col" style={{ background:"#0d1418" }}>
          ...
          <div className="flex-1 overflow-y-auto px-3 py-3 flex flex-col gap-2"
            ...
            <div className="flex justify-end">
              <div className="max-w-[80%] rounded-lg px-2.5 py-2 relative" style={{ background:"#005c4b" }}>
                ...
                <div className="flex items-center justify-end gap-1 mt-1">
                  <span className="text-white/50" style={{ fontSize:6 }}>2:41</span>
            ...
            <div className="flex justify-start">
              <div className="max-w-[65%] rounded-lg px-2.5 py-2 relative" style={{ background:"#1f2c34" }}>
                <div className="text-white" style={{ fontSize:7.5 }}>Sí! Me anoto para mañana 😊</div>
                <div className="text-white/40 text-right mt-0.5" style={{ fontSize:6 }}>2:55</div>
